...
public class Controller {
    ...
    public ResponseEntity<Void> deleteExperiencia(@PathVariable Long experienciaId) {
        this.experienciaService.deleteExperiencia(experienciaId);
    ...
    @GetMapping("/experiencia/nome/{nomeEmpresa}")
    ...
    @GetMapping("/formacao/nome/{nomeFormacao}")
    ...
    @GetMapping("/certificado/horas/{quantidadeHoras}")
